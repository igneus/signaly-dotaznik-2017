...
\includegraphics{graphs/img/na_signalech_mam_profil.pdf}

\subsubsection{O Signálech jsem se poprvé dozvěděl/a}

\includegraphics{graphs/img/o_signalech_jsem_se_poprve_dozvedel.pdf}

\subsubsection{Na Signály chodím}

\includegraphics{graphs/img/na_signaly_chodim.pdf}

\subsection{K čemu Signály používám}\label{sec:kcemu}

\subsubsection{Na Signály chodím hlavně}

\includegraphics{graphs/img/na_signaly_chodim_hlavne.pdf}

\subsubsection{Signály jsem využil/a k}

\includegraphics{graphs/img/signaly_jsem_vyuzil_k.pdf}

\subsubsection{Na Signálech \uv{se mi povedlo}}

\includegraphics{graphs/img/na_signalech_se_mi_povedlo.pdf}

\subsection{Funkcionality, které využívám}\label{sec:funkcionality}

\subsubsection{Jsem autorizovaný/á}

\includegraphics{graphs/img/jsem_autorizovany.pdf}
...
\includegraphics{graphs/img/pouzivas_dalsi_socialni_site.pdf}
...
\includegraphics{graphs/img/na_signalech_jsem_zazil.pdf}
...
\includegraphics{graphs/img/jsem.pdf}

\subsubsection{Věk}

\includegraphics{graphs/img/vek.pdf}

\subsubsection{Studuji}

\includegraphics{graphs/img/studuji.pdf}

\subsubsection{(Jen žáci a studenti) Jsem žák / student}

\subsubsection{Moje nejvyšší dosažené vzdělání}

\includegraphics{graphs/img/moje_nejvyssi_dosazene_vzdelani.pdf}
